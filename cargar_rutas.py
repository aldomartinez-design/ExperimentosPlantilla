...
working_directory='C:\\Users\\hp\\Desktop\\RGVRepositorios\\ExperimentosPlantilla'
...
def crear_admin():
    with app.app_context():
        ...
        # usuario admin
        usuario = [
            {'id_visualizacion':int(1),'nombre': 'Sistema','correo_electronico':'aldo.martinez@rgvsoluciones.com','contrasena':'123','ultimo_cambio_de_contrasena':'2025-09-09','estatus': 'Activo'}
        ]
